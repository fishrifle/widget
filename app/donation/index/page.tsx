...
export default function DonationLanding() {
  ...
  // only allow proceed once amount is set (>0) and cause is chosen
  const canProceed = amount !== "" && Number(amount) > 0 && !!cause;
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow space-y-6 p-6"></div>
      {/* Header */}
      <h2 className="text-2xl font-bold">PassItOn</h2>
